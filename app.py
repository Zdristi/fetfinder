...
LANGUAGES = {
    'en': {
        ...
        'gift_conversion': 'Convert Gifts to Coins',
        'available_gifts_for_conversion': 'Available Gifts for Conversion',
        'conversion_rate_info': 'Convert your received gifts to coins at 50% of their original value',
        'loading': 'Loading...',
        'premium_day': '1 Day',
        'premium_week': '1 Week',
        ...
        'undo_swipe_desc': 'Undo your last swipe',
        'profile_boost': 'Profile Boost',
        'profile_boost_desc': 'Boost your profile for 30 minutes',
        'profile_highlight': 'Profile Highlight',
        'profile_highlight_desc': 'Highlight your profile for 24 hours',
        'extended_search': 'Extended Search',
        'extended_search_desc': 'Extended search for 1 day',
        'total_coins_available': 'Total Coins Available',
        'convert_all_gifts': 'Convert All Gifts',
        'from': 'From',
        'original_price': 'Original Price',
        'conversion_value': 'Conversion Value',
        'convert_now': 'Convert Now',
        'error_loading_gifts': 'Error loading gifts for conversion',
        'error_converting_gift': 'Error converting gift',
        'no_gifts_to_convert': 'No gifts to convert',
        'error_converting_gifts': 'Error converting gifts',
        'error_purchasing_premium': 'Error purchasing premium',
        'error_purchasing_feature': 'Error purchasing feature',
        'new_gift': 'New Gift!',
    ...
    'ru': {
        ...
        'gift_conversion': 'Конвертация подарков в монеты',
        'available_gifts_for_conversion': 'Доступные подарки для конвертации',
        'conversion_rate_info': 'Конвертируйте полученные подарки в монеты по 50% от их первоначальной стоимости',
        'loading': 'Загрузка...',
        'premium_day': '1 День',
        'premium_week': '1 Неделя',
        'premium_month': '1 Месяц',
        'premium_year': '1 Год',
        'buy_now': 'Купить сейчас',
        'premium_features': 'Премиум-функции',
        'undo_swipe': 'Отмена свайпа',
        'undo_swipe_desc': 'Отмените ваш последний свайп',
        'profile_boost': 'Буст профиля',
        'profile_boost_desc': 'Поднять ваш профиль на 30 минут',
        'profile_highlight': 'Выделение профиля',
        'profile_highlight_desc': 'Выделить ваш профиль на 24 часа',
        'extended_search': 'Расширенный поиск',
        'extended_search_desc': 'Расширенный поиск на 1 день',
        'total_coins_available': 'Всего монет доступно',
        'convert_all_gifts': 'Конвертировать все подарки',
        'from': 'От',
        'original_price': 'Первоначальная цена',
        'conversion_value': 'Стоимость конвертации',
        'convert_now': 'Конвертировать сейчас',
        'error_loading_gifts': 'Ошибка загрузки подарков для конвертации',
        'error_converting_gift': 'Ошибка конвертации подарка',
        'no_gifts_to_convert': 'Нет подарков для конвертации',
        'error_converting_gifts': 'Ошибка конвертации подарков',
        'error_purchasing_premium': 'Ошибка покупки премиума',
        'error_purchasing_feature': 'Ошибка покупки функции',
        'new_gift': 'Новый подарок!',
        'anonymous_gift': 'Анонимный подарок!'
    }
        'find_match': 'Найдите свою идеальную пару',
        'description': 'FetDate - это современная платформа для знакомств, где вы можете найти совпадения по общим интересам и фетишам.',
        'create_profile': 'Создать профиль',
...
def api_send_gift():
    try:
        ...
        from models import Notification
        title = get_text('new_gift') if not is_anonymous else get_text('anonymous_gift')
        if lang == 'ru':
