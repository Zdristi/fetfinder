...
class UserPhoto(db.Model):
    ...
    # Relationship - properly defining the bidirectional relationship with User.photos
    user = db.relationship('User', back_populates="photos", backref=db.backref('user_photos', lazy=True))
